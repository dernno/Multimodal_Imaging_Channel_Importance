...
#SBATCH -t 12:00:00     # 4 Tage, 0 Stunden, 0 Minuten
#SBATCH --gres=gpu:A100:1
#SBATCH --output=/mimer/NOBACKUP/groups/snic2021-7-128/nora/letitshine/out/Ablation_100%j.out
