...
#SBATCH --output=/mimer/NOBACKUP/groups/snic2021-7-128/nora/letitshine/out/Baseline_P123_20_ResNet18_inference%j.out
...
python /mimer/NOBACKUP/groups/snic2021-7-128/nora/letitshine/codes/inference.py \
	...
	--weighted_patients \
	--inference_pth '/mimer/NOBACKUP/groups/snic2021-7-128/nora/logs/Baseline_P123_20_ResNet18_FL only/resnet18_FL only train inputnorm'\
	--note '345' \
