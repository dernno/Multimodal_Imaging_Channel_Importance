...
#SBATCH --output=/mimer/NOBACKUP/groups/snic2021-7-128/nora/letitshine/out/LATE_inference%j.out
...
python /mimer/NOBACKUP/groups/snic2021-7-128/nora/letitshine/codes/inference.py \
	...
	--mode MM --fusion_mode L --channel 7 --mixup --split_mode "train_test" --pretrained True \
	--server alvis \
	--model_arch_name resnet18 \
	--group_partition_name 'partition123' \
	--weighted_patients \
	--inference_pth '/mimer/NOBACKUP/groups/snic2021-7-128/nora/logs/Baseline_P123_20_ResNet18_Late Fusion/resnet18_multimodal_late_fusion'\
